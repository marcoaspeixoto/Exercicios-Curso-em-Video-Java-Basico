...
public class TelaValores1 extends javax.swing.JFrame {
    ...
    private void btnDividirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDividirActionPerformed
        ...
        double denominador = Integer.parseInt(txtDem.getText());
        double divisao = numerador / denominador;
        double raiz = (double) Math.sqrt(numerador);
        lblDiv.setText(Double.toString(divisao));
        lblRes.setText(Double.toString(raiz));
